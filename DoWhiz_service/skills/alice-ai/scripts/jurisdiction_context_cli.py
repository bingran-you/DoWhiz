...
"""CLI helpers for Alice Step 5 jurisdiction context."""
...
def main() -> int:
    ...
    context = build_jurisdiction_context(request, subject_resolution, session_state)
    emit_json(summarize_jurisdiction_context(context) if args.summary else context, args.compact)
    return 0
