# Alice Recommendation Shortlist: Open discovery across the observed candidate universe for rural hold under $300k.
...
- Active thesis families: recreational_rural_hold
- Budget ceiling: $300,000.00

## Candidate Universe
- Observed candidates: 3
- Acquisition mode: open discovery
...
- Observation limit: Open discovery currently depends on the listing candidates Alice has already observed and processed.
...
- Warning: At least one observed candidate failed a hard request constraint and stayed visible only for transparency.
...
### 2. Land.com listing 55555555 near 25 Acres in Autauga County Alabama (AL)
...
- Fit summary: mixed across recreational_rural_hold.
...
- Land.com listing 60606060 near Bakersfield, Kern County, CA: Listing ask of $640,000.00 is above the user-stated budget ceiling.
  - Blocker: Competing parcel candidates remain active, so parcel-specific thesis conclusions cannot be treated as final.
  - Blocker: Flood screening was not completed or lacked a defensible point/parcel geometry.
